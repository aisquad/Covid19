...
"""
    2020 by Igor REMOLAR.
    These functions have been created to clean any results because any items in downloaded files have
    a lot of inconsistencies.
    
    fix_country() fixes the name of the country because of a same region can be named with several names: we can find
    Hong Kong or Hong Kong SAR as a country or as dependent of China and several other similar cases.
    
    sanitize() pretends to regularize the name of the keys. We can find Long_ and Longitude for longitude
"""
